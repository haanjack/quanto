#!/usr/bin/env python3
"""
Test: Quantize Llama3.1-8B-Instruct to INT8

Model: ~/models/meta-llama/Llama3.1-8b-instruct
Output: ./outputs/llama3.1-8b-int8
...
def main() -> int:
    print("=" * 60)
    print("Test: Quantize Meta-Llama-3-8B to INT8")
    print("=" * 60)

    model_path = Path("/models/meta-llama/Meta-Llama-3-8B")
    output_dir = Path("/output/llama3-8b-int8")
